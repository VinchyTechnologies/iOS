...
public struct ImageRequest: CustomStringConvertible {
  ...
  {
    ref = Container(resource: Resource.url(url), processors: processors, cachePolicy: cachePolicy, priority: priority, options: options)
  ...
  public init(
    ...
    options: ImageRequestOptions = .init())
  {
    ref = Container(resource: Resource.urlRequest(urlRequest), processors: processors, cachePolicy: cachePolicy, priority: priority, options: options)
...
public struct ImageRequestOptions {
  ...
  public init(
    memoryCacheOptions: MemoryCacheOptions = .init(),
  ...
  struct LoadKeyForOriginalImage: Hashable {
    ...
    private struct Parameters: Hashable {
      ...
      init(_ request: ImageRequest) {
        ...
        requestCachePolicy = request.cachePolicy
...
// MARK: - ImageRequest + ImageRequestConvertible
...
// MARK: - URL + ImageRequestConvertible
...
// MARK: - URLRequest + ImageRequestConvertible
