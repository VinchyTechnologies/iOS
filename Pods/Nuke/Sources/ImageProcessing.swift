...
extension PlatformImage {
  ...
  fileprivate func draw(inCanvasWithSize canvasSize: CGSize, drawRect: CGRect? = nil) -> PlatformImage? {
  ...
  fileprivate func decompressed() -> PlatformImage? {
    guard let cgImage = cgImage else {
      return nil
    }
...
extension PlatformImage {
  fileprivate var processed: ImageProcessingExtensions {
...
extension CGFloat {
  fileprivate func converted(to unit: ImageProcessingOptions.Unit) -> CGFloat {
    switch unit {
...
extension CGSize {
  ...
  /// if needed.
  fileprivate init(size: CGSize, unit: ImageProcessingOptions.Unit) {
    switch unit {
  ...
  fileprivate func rounded() -> CGSize {
...
#if os(iOS) || os(tvOS) || os(watchOS)
extension CGSize {
  fileprivate func rotatedForOrientation(_ imageOrientation: UIImage.Orientation) -> CGSize {
...
extension CGContext {
  fileprivate static func make(_ image: CGImage, size: CGSize, alphaInfo: CGImageAlphaInfo? = nil) -> CGContext? {
