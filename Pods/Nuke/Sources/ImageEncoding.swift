  ...
  public struct ImageIO: ImageEncoding {
    ...
    public static func isSupported(type: ImageType) -> Bool {
      ...
      let isAvailable = CGImageDestinationCreateWithData(
        NSMutableData() as CFMutableData, type.rawValue as CFString, 1, nil) != nil
    ...
    public func encode(_ image: PlatformImage) -> Data? {
      ...
      guard
        ...
        let destination = CGImageDestinationCreateWithData(
          data as CFMutableData, type.rawValue as CFString, 1, nil) else
      {
        return nil
      }
