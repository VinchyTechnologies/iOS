...
protocol CollectionViewLayout: AnyObject {
  var state: ParchmentPagingState { get set }
...
// MARK: - PagingCollectionViewLayout + CollectionViewLayout

extension PagingCollectionViewLayout: CollectionViewLayout {}

// MARK: - ParchmentCollectionView

protocol ParchmentCollectionView: AnyObject {
...
// MARK: - UICollectionView + ParchmentCollectionView

extension UICollectionView: ParchmentCollectionView {}
...
extension ParchmentCollectionView {
