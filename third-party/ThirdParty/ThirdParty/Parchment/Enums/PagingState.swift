...
public enum ParchmentPagingState: Equatable {
  case empty
...
extension ParchmentPagingState {
...
public func == (lhs: ParchmentPagingState, rhs: ParchmentPagingState) -> Bool {
  switch (lhs, rhs) {
  case
    (
    ...
    if
      lhsCurrent.isEqual(to: rhsCurrent),
