...
public protocol EmailServiceProtocol: AnyObject {
    func getEmailController(HTMLText: String?, recipients: [String]) -> MFMailComposeViewController
...
public final class EmailService: NSObject, EmailServiceProtocol {
    ...
    public func getEmailController(HTMLText: String?, recipients: [String]) -> MFMailComposeViewController {
