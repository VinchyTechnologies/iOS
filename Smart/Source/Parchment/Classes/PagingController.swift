...
final class PagingController: NSObject {
  ...
  weak var collectionView: ParchmentCollectionView! {
    didSet {
  ...
  private(set) var state: ParchmentPagingState {
    didSet {
  ...
  @objc
  private dynamic func handleSwipeGestureRecognizer(_ recognizer: UISwipeGestureRecognizer) {
...
extension PagingController: UICollectionViewDataSource {
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    let cell = collectionView.dequeueReusableCell(
      ...
      for: indexPath) as! PagingCell // swiftlint:disable:this force_cast
