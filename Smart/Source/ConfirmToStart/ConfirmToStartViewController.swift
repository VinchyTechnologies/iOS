//
//  ConfirmToStartViewController.swift
//  Smart
//
...
protocol ConfirmToStartViewControllerDelegate: AnyObject {
...
final class ConfirmToStartViewController: UIViewController {
    ...
    private lazy var iamold: SwitcherWithText = {
        ...
        view.decorate(model: .init(attributedText: NSAttributedString(string: localized("legal_age"), font: Font.medium(18), textColor: .dark)))
        return view
    }()
